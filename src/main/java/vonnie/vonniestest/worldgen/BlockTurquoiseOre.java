...
public class BlockTurquoiseOre extends Block {
    ...
    public static final ResourceLocation TURQUOISE_ORE = new ResourceLocation(vonniestest.MODID, "turquoise_ore");
    ...
    public BlockTurquoiseOre() {
        ...
        setTranslationKey(vonniestest.MODID + ".turquoise_ore");
