...
public class GenericBlock extends Block {
    ...
    public static final Pattern COMPILE = Pattern.compile("@", Pattern.LITERAL);
    ...
    public void getDrops(NonNullList<ItemStack> result, IBlockAccess world, BlockPos pos, IBlockState metadata, int fortune) {
        ...
        //Always check this!
        if (tileEntity instanceof IRestorableTileEntitiy) {
            ItemStack stack = new ItemStack(Item.getItemFromBlock(this));
            NBTTagCompound tagCompound = new NBTTagCompound();
            ((IRestorableTileEntitiy)tileEntity).writeRestorableToNBT(tagCompound);
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (tileEntity instanceof IRestorableTileEntitiy) {
            ...
            if (tagCompound != null) {
                ((IRestorableTileEntitiy) tileEntity).readRestorableFromNBT(tagCompound);
            }
        }
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        player.openGui(vonniestest.instance, 0, world, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
