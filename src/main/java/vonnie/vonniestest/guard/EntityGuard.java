...
public class EntityGuard extends EntityCreature  implements IAnimals {
    public static final ResourceLocation LOOT = new ResourceLocation(vonniestest.MODID, "entities/guard");
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(3,new EntityAINearestAttackableTarget<>(this, EntityLiving.class,4,false,true, entity -> entity != null && IMob.VISIBLE_MOB_SELECTOR.apply(entity)));
    }
