...
public class GuardAIFollow extends EntityAIBase {
    ...
    public boolean shouldContinueExecuting() {
        return this.followingPlayer != null && !this.navigation.noPath() && this.entity.getDistanceSq(this.followingPlayer) > (double) (this.stopDistance);
    }
    ...
    public void updateTask() {
        if (this.followingPlayer != null && !this.entity.getLeashed()) {
            ...
            if (--this.timeToRecalcPath <= 0) {
                ...
                if (squaredDist > (double) (this.stopDistance)) {
